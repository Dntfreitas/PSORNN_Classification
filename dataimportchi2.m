...
output_car = car(:, end)';
input_car = feature_selection_chi2(input_car, output_car);
...
input_parkinsons = feature_selection_chi2(input_parkinsons, output_parkinsons);
...
input_red_wine = feature_selection_chi2(input_red_wine, output_red_wine);
...
input_white_wine = feature_selection_chi2(input_white_wine, output_white_wine);
